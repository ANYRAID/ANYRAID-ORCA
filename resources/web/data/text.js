var LangText = {
  en: {
    t1: "Welcome to ANYRAID-ORCA",
    t2: "ANYRAID-ORCA will be setup in several steps. Let's start!",
    t3: "User Agreement",
    t4: "Disagree",
    t5: "Agree",
    ...
    t65: "Please be aware that these plugins are not developed or maintained by ANYRAID-ORCA. They should be used at your own discretion and risk.",
    ...
    t83: "2, Close all open ANYRAID-ORCA",
    t84: "3, Delete all files under the plug-in directory",
    t85: "4, Reopen ANYRAID-ORCA and install the plug-in again",
    t86: "Close",
    t87: "User Manual",
    t88: "Remove",
    ...
    orca3: "Stealth Mode",
    orca4: "Stealth Mode prevents network access, including third-party printer connections and cloud features. Users who prefer to work entirely offline can enable this option.",
    ...
    orca11: "Connected",
    orca12: "Note: When Stealth Mode is enabled, online printer connections and cloud features are unavailable.",
  },
  ca_ES: {
    t1: "Benvingut a ANYRAID-ORCA",
    t2: "ANYRAID-ORCA es configurarà en diversos passos. Comencem!",
    ...
    t65: "Tingues en compte que aquests connectors no són desenvolupats ni mantinguts per ANYRAID-ORCA. S'han d'utilitzar a la teva discreció i risc.",
    ...
    t83: "2, Tanca totes les ANYRAID-ORCA obertes",
    t84: "3, Elimina tots els fitxers del directori de connectors",
    t85: "4, Reobre ANYRAID-ORCA i instal·la el connector de nou",
    t86: "Tancar",
  ...
  es_ES: {
    t1: "Bienvenido a ANYRAID-ORCA",
    t2: "ANYRAID-ORCA se configurará mediante varios pasos. ¡Comencemos!",
    t3: "Términos de uso",
    t4: "No acepto",
    t5: "Acepto",
    ...
    t65: "Tenga en cuenta que estos complementos no están desarrollados ni mantenidos por ANYRAID-ORCA. Deben usarse bajo su propia responsabilidad.",
    ...
    t83: "2. Cierre todas las instancias de ANYRAID-ORCA",
    t84: "3. Elimine todos los archivos del directorio de complementos",
    t85: "4. Vuelva a abrir ANYRAID-ORCA e instale el complemento de nuevo",
    t86: "Cerrar",
  ...
  it_IT: {
    t1: "Benvenuti in ANYRAID-ORCA",
    t2: "ANYRAID-ORCA verrà configurato seguendo diversi passaggi. Cominciamo!",
    t3: "Condizioni d'uso",
    t4: "Non accetto",
    t5: "Accetto",
    ...
    t65: "Si prega di notare che questi moduli non sono sviluppati o mantenuti da ANYRAID-ORCA. Dovrebbero essere utilizzati a proprio rischio e discrezione.",
    ...
    t83: "2, Chiudere tutte le istanze di ANYRAID-ORCA",
    t84: "3, Eliminare tutti i file all'interno della directory del modulo",
    t85: "4, Riaprire ANYRAID-ORCA e installare nuovamente il modulo",
    t86: "Chiudi",
    t87: "Manuale d'uso",
    t88: "Rimuovi",
  ...
  de_DE: {
    t1: "Willkommen im ANYRAID-ORCA",
    t2: "Das ANYRAID-ORCA wird in mehreren Schritten eingerichtet. Lass uns anfangen!",
    ...
    t83: "2, Schließen Sie alle geöffneten ANYRAID-ORCA",
    t84: "3, Löschen Sie alle Dateien im Plug-in-Verzeichnis",
    t85: "4, Öffnen Sie ANYRAID-ORCA erneut und installieren Sie das Plug-in erneut",
    t86: "Schließen",
  ...
  cs_CZ: {
    t1: "Vítejte v ANYRAID-ORCA",
    t2: "ANYRAID-ORCA bude nastaven v několika krocích. Začněme!",
    ...
    t83: "2, Zavřete všechny otevřené ANYRAID-ORCA",
    t84: "3, Smažte všechny soubory v adresáři plug-in",
    t85: "4, znovu otevřete ANYRAID-ORCA a znovu nainstalujte zásuvný modul",
    t86: "Zavřít",
  ...
  fr_FR: {
    t1: "Bienvenue sur ANYRAID-ORCA",
    t2: "ANYRAID-ORCA sera configuré en plusieurs étapes. Commençons !",
    ...
    t65: "Veuillez noter que ces plugins ne sont pas développés ou maintenus par ANYRAID-ORCA. Ils doivent être utilisés à votre propre discrétion et à vos propres risques.",
    ...
    t83: "2, Fermez toutes les fenêtres de ANYRAID-ORCA",
    t84: "3, Supprimez tous les fichiers dans le répertoire du plug-in",
    t85: "4, Relancez ANYRAID-ORCA et réinstallez le plug-in.",
    t86: "Fermer",
    ...
    wk2: "Cet article présente l'utilisation la plus basique de ANYRAID-ORCA. Il guide les utilisateurs pour configurer le logiciel, créer des projets et effectuer la première tâche d'impression étape par étape.",
    wk3: "Workflow basé sur des projets",
    wk4: "ANYRAID-ORCA met en avant un workflow de pointe pour véritablement réaliser un projet « tout en un ». Basé sur le format de projet 3MF grand public, il fournit une série de nouvelles fonctionnalités révolutionnaires, telles que la prise en charge de plusieurs plaques, un gestionnaire de ressources de projet et une vue d'assemblage/de pièce. Cela améliore considérablement l'efficacité des créateurs et des utilisateurs réguliers",
    wk5: "Impression haute vitesse de qualité",
    wk6: "Il est difficile d'imprimer à grande vitesse tout en maintenant une qualité élevée. ANYRAID-ORCA rend cela possible. « Arch Move » permet à la hotend de se déplacer en douceur et réduit les vibrations de la machine. Le refroidissement intelligent est basé sur des paramètres de refroidissement affinés pour chaque type de filament. Le « ralentissement automatique » pour les paroies en porte-à-faux permet d'éviter la déformation à grande vitesse.",
    wk7: "Impression multi-couleur",
    wk8: "ANYRAID-ORCA fournit des outils de colorisation polyvalents pour créer un modèle coloré. Vous pouvez librement ajouter/supprimer des filaments dans un projet et coloriser votre modèle avec différents pinceaux. Avant l'impression, chaque filament sera automatiquement mappé sur un emplacement AMS, sans avoir besoin de modifier manuellement le placement de la bobine dans l'AMS.",
    wk9: "Guide de réglage des paramètres de découpage",
    wk10: "Les fonctionnalités de gestion des paramètres de ANYRAID-ORCA offrent un contrôle très flexible et puissant sur le processus de découpage. Cet article présente l'organisation des paramètres et fournit quelques compétences pour tirer pleinement parti de ces fonctionnalités.",
    wk11: "Contrôle et surveillance à distance",
    wk12: "ANYRAID-ORCA prend en charge l'envoi du travail d'impression à votre imprimante via le réseau WAN/LAN, contrôlant et surveillant chaque aspect de votre imprimante 3D et des travaux d'impression. Si vous avez plusieurs imprimantes, vous pouvez facilement basculer entre elles dans la liste des périphériques.",
    wk13: "Format STEP",
    ...
    wk15: "Texte 3D",
    wk16: "Avec l'outil Texte 3D, les utilisateurs peuvent facilement créer diverses formes de texte 3D dans le projet, ce qui rend le modèle plus personnalisé. ANYRAID-ORCA fournit des dizaines de polices et prend en charge les styles gras et italique pour donner au texte une plus grande flexibilité.",
    orca6: "Bambu Cloud",
    orca7: "Orca Cloud Account",
    orca8: "Not signed in",
    orca9: "Bambu Cloud Account",
  ...
  zh_CN: {
    t1: "欢迎使用ANYRAID-ORCA",
    t2: "ANYRAID-ORCA需要几步安装步骤，让我们开始吧！",
    t3: "用户使用协议",
    t4: "拒绝",
    t5: "同意",
    t6: "帮助提升ANYRAID-ORCA性能",
    t7: "允许发送匿名数据",
    t8: "上一步",
    t9: "下一步",
    t10: "选择打印机",
    ...
    t64: "Bambu网络插件",
    t65: "注意：这些插件不是由ANYRAID-ORCA开发或维护的。使用它们需自担风险",
    t66: "强大的远程控制功能",
    t67: "实时视频流",
    t68: "用户数据同步",
    t69: "安装Bambu网络插件",
    ...
    t81: "1, 点击",
    t82: "打开插件所在目录",
    t83: "2, 关闭所有ANYRAID-ORCA",
    t84: "3, 删除插件所在目录下的所有文件",
    t85: "4, 重新启动ANYRAID-ORCA并尝试安装插件",
    t86: "关闭",
    t87: "使用引导",
    t88: "移除",
    t89: "打开所在的文件夹",
    ...
    t126: "正在加载……",
    wk1: "快速入门指南",
    wk2: "本文介绍了ANYRAID-ORCA的最基本用法。它指导用户配置软件，创建项目，并逐步完成第一个打印任务。",
    wk3: "基于项目的工作流",
    wk4: "ANYRAID-ORCA提出了领先的工作流程，真正实现了“一体化”项目。基于主流的3MF项目格式，它提供了一系列革命性的新功能，如支持多盘、项目资源管理器和装配/零件视图。它可以大幅提高模型创作者及普通用户的使用效率。",
    wk5: "质量卓越的高速打印",
    wk6: "在保持高质量的前提下进行高速打印是非常具有挑战性的。ANYRAID-ORCA让这一切发生。支持“圆弧移动”特性使工具头移动更加顺滑，有效减少机器振动。基于不同材料类型的精细标定过的冷却控制参数，使得冷却过程可以自动开展。在悬垂区域进行“自动减速”，可防止高速打印时在此区域的外观瑕疵。",
    wk7: "多色打印",
    wk8: "ANYRAID-ORCA提供了多种着色工具来制作彩色模型。您可以在项目中自由添加/移除打印材料，并使用不同的笔刷为模型着色。开始打印时，打印任务中的各个材料将自动映射到匹配的AMS槽位，无需手动调整AMS中的料卷位置。",
    wk9: "切片参数设置指南",
    wk10: "ANYRAID-ORCA中的参数管理功能为切片过程提供了非常灵活和强大的控制。本文介绍了切片参数的组织分类和设置方法，并提供了一些使用技巧。",
    wk11: "远程控制和监控",
    wk12: "ANYRAID-ORCA支持通过WAN/LAN网络向打印机发送打印任务，控制和查看3D打印机和打印任务的各个方面。如果您有多台打印机，还可以在设备列表中轻松切换。",
    wk13: "STEP格式",
    wk14: "与STL相比，STEP带来了更多有效的信息。由于STEP的高精度，切片时可以生成更多的圆弧路径。STEP还包括模型每个零件的装配关系，可分割模型后恢复装配视图。",
    wk15: "3D文本",
    wk16: "使用3D文本工具，用户可以轻松地在项目中创建各种3D文本形状，使模型更加个性化。ANYRAID-ORCA提供了数十种字体，并支持粗体和斜体样式，使文本具有更大的灵活性。",
    orca1: "编辑项目信息",
    orca2: "该模型没有相关信息",
    orca6: "Bambu Cloud",
    orca7: "Orca Cloud Account",
  ...
  zh_TW: {
    t1: "歡迎使用 ANYRAID-ORCA",
    t2: "ANYRAID-ORCA 需要幾步安裝步驟，讓我們開始吧！",
    t3: "使用者協議",
    t4: "拒絕",
    t5: "同意",
    t6: "幫助提升 ANYRAID-ORCA 性能",
    t7: "允許傳送匿名數據",
    t8: "上一步",
    t9: "下一步",
    t10: "選擇３Ｄ列印機",
    ...
    t81: "1, 點擊",
    t82: "打開插件所在目錄",
    t83: "2, 關閉所有 ANYRAID-ORCA",
    t84: "3, 刪除插件所在目錄下的所有文件",
    t85: "4, 重新啟動 ANYRAID-ORCA 並嘗試安裝插件",
    t86: "關閉",
    t87: "使用引導",
    t88: "移除",
    t89: "打開所在的文件夾",
    ...
    t92: "Bambu聖誕小屋",
    wk1: "快速入門指南",
    wk2: "本文介紹了 ANYRAID-ORCA 的最基本用法。它指導用戶配置軟體，創建項目，並逐步完成第一個列印任務。",
    wk3: "基於項目的工作流",
    wk4: "ANYRAID-ORCA 提出了領先的工作流程，真正實現了“一體化”項目。基於主流的3MF項目格式，它提供了一系列革命性的新功能，如支持多盤、項目資源管理器和裝配/零件視圖。它可以大幅提高模型創作者及普通用戶的使用效率。",
    wk5: "質量卓越的高速列印",
    wk6: "在保持高品質的前提下進行高速列印是非常具有挑戰性的。ANYRAID-ORCA 讓這一切發生。支持“圓弧移動”特性使工具頭移動更加順滑，有效減少機器振動。基於不同線材類型的精細標定過的冷卻控制參數，使得冷卻過程可以自動開展。在懸垂區域進行“自動減速”，可防止高速列印時在此區域的外觀瑕疵。",
    wk7: "多色列印",
    wk8: "ANYRAID-ORCA 提供了多種著色工具來製作彩色模型。您可以在項目中自由添加/移除列印材料，並使用不同的筆刷為模型著色。開始列印時，列印任務中的各個線材將自動映射對應到 AMS 槽位，無需手動調整 AMS 中的線材位置。",
    wk9: "切片參數設置指南",
    wk10: "ANYRAID-ORCA 中的參數管理功能為切片過程提供了非常靈活和強大的控制。本文介紹了切片參數的組織分類和設置方法，並提供了一些使用技巧。",
    wk11: "遠端控制和監控",
    wk12: "ANYRAID-ORCA 支持透過無線網路/區域網路向３Ｄ列印機發送列印任務，控制和查看３Ｄ列印機和列印任務的各個方面。如果您有多台３Ｄ列印機，還可以在設備清單中輕鬆切換。",
    wk13: "STEP格式",
    wk14: "與 STL 相比，STEP 帶來了更多有效的資訊。由於 STEP 的高精度，切片時可以生成更多的圓弧路徑。STEP 還包括模型每個零件的組裝關係，可分割模型後恢復裝配視圖。",
    wk15: "３Ｄ文本",
    wk16: "使用３Ｄ文字工具，使用者可以輕鬆地在項目中建立各種３Ｄ文字形狀，使模型更加個性化。ANYRAID-ORCA 提供了數十種字體，並支援粗體和斜體樣式，使文字具有更大的靈活性。",
    orca1: "編輯專案資訊",
    orca2: "沒有模型相關資訊",
    orca6: "Bambu Cloud",
    orca7: "Orca Cloud Account",
  ...
  ru_RU: {
    t1: "Приветствуем в ANYRAID-ORCA!",
    t2: "Для настройки ANYRAID-ORCA необходимо пройти несколько этапов. Давайте начнём!",
    ...
    t65: "Имейте в виду, что эти плагины не разрабатываются и не поддерживаются ANYRAID-ORCA. Используйте их на свой страх и риск.",
    ...
    t83: "2, Закройте все окна ANYRAID-ORCA",
    t84: "3, Удалите все файлы в папке плагина",
    t85: "4, Откройте ANYRAID-ORCA и снова установите плагин.",
    t86: "Закрыть",
    t87: "Инструкции",
    t88: "Удалить",
  ...
  ko_KR: {
    t1: "ANYRAID-ORCA에 오신 것을 환영합니다",
    t2: "ANYRAID-ORCA는 여러 단계로 설정됩니다. 시작!",
    t3: "사용자 약관",
    t4: "거부",
    t5: "동의",
    ...
    t83: "2, 열려 있는 모든 ANYRAID-ORCA를 닫습니다.",
    t84: "3, 플러그인 디렉터리 아래의 모든 파일 삭제합니다",
    t85: "4, ANYRAID-ORCA를 다시 열고 플러그인을 다시 설치하세요.",
    t86: "닫기",
    t87: "사용자 메뉴얼",
    t88: "제거",
    t89: "포함된 폴더 열기",
  ...
  tr_TR: {
    t1: "ANYRAID-ORCA'a hoş geldiniz",
    ...
    t65: "Lütfen bu eklentilerin ANYRAID-ORCA tarafından geliştirilmediğini veya bakımının yapılmadığını unutmayın. Kendi takdirinize ve riskinize göre kullanılmalıdırlar.",
    ...
    t85: "4, ANYRAID-ORCA'ı yeniden açın ve eklentiyi tekrar yükleyin",
    t86: "Kapat",
  ...
  pl_PL: {
    t1: "Witamy w ANYRAID-ORCA",
    t2: "ANYRAID-ORCA zostanie skonfigurowany w kilku krokach. Zacznijmy!",
    ...
    t65: "Proszę mieć świadomość, że te wtyczki nie są rozwijane ani utrzymywane przez ANYRAID-ORCA. Powinny być używane na własne ryzyko i z rozwagą.",
    ...
    t83: "2, Zamknij wszystkie otwarte ANYRAID-ORCA",
    t84: "3, Usuń wszystkie pliki z katalogu wtyczek",
    t85: "4, Ponownie otwórz ANYRAID-ORCA i zainstaluj wtyczkę ponownie",
    t86: "Zamknij",
  ...
  pt_BR: {
    t1: "Bem-vindo ao ANYRAID-ORCA",
    t2: "ANYRAID-ORCA será configurado em várias etapas. Vamos começar!",
    t3: "Termos de Uso",
    t4: "Discordo",
    t5: "Concordo",
    ...
    t65: "Por favor seja cuidadoso estes plugins não são desenvolvidos ou mantidos por ANYRAID-ORCA. Eles devem ser usados por sua conta e risco.",
    ...
    t83: "2, Feche totalmente o ANYRAID-ORCA",
    t84: "3, Delete todos os arquivos na pasta do plug-in",
    t85: "4, Reabra o ANYRAID-ORCA e instale o plug-in novamente",
    t86: "Fechar",
  ...
  lt_LT: {
    t1: "Pasisveikinkite su ANYRAID-ORCA",
    t2: "ANYRAID-ORCA bus nustatyta per kelis žingsnius. Pradėkime!",
    ...
    t65: "Atkreipkite dėmesį, kad ANYRAID-ORCA šių papildinių nesukuria ir neprižiūri. Juos turėtumėte naudoti savo nuožiūra ir rizika.",
    ...
    t83: "2, Uždarykite visas veikiančias ANYRAID-ORCA programas",
    t84: "3, Ištrinkite visus failus iš papildinių katalogo",
    t85: "4, Iš naujo atverkite ANYRAID-ORCA ir iš naujo įdiekite papildinį",
    t86: "Užverti",
