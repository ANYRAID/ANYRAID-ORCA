...
#define SLIC3R_APP_FULL_NAME "ANYRAID-ORCA"
#define GCODEVIEWER_APP_NAME "ANYRAID-ORCA G-code Viewer"
#define GCODEVIEWER_APP_KEY  "ANYRAID-ORCAGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("ANYRAID-ORCA G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
