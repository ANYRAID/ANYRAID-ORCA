    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
{
    ...
    this->logo = ScalableBitmap(this, "ANYRAID-ORCA_about_192px", 192);
...
wxString CopyrightsDialog::get_html_text()
{
    ...
    wxString text = wxString::Format(
        ...
        _L("License"),
        _L("ANYRAID-ORCA is licensed under "),
        "https://www.gnu.org/licenses/agpl-3.0.html",_L("GNU Affero General Public License, version 3"),
        _L("ANYRAID-ORCA is derived from OrcaSlicer, which is based on PrusaSlicer and BambuStudio"),
        _L("Libraries"),
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    // logo
    m_logo_bitmap = ScalableBitmap(this, "ANYRAID-ORCA_about_192px", 125);
    ...
    text_list.push_back(_L("OrcaSlicer continued that tradition, drawing from PrusaSlicer, BambuStudio, SuperSlicer, and CuraSlicer while contributing advanced calibration, wall, seam, and workflow capabilities to the open-source community."));
    text_list.push_back(_L("ANYRAID-ORCA is a branded derivative of OrcaSlicer for ANYRAID development workflows. It preserves the upstream project history, licenses, and third-party attributions."));
    ...
    wxStaticText *html_text = new wxStaticText(this, wxID_ANY, "Copyright(C) 2026 ANYRAID · Derived from OrcaSlicer", wxDefaultPosition, wxDefaultSize);
    ...
    m_html = new wxHtmlWindow(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHW_SCROLLBAR_NEVER /*NEVER*/);
      {
          ...
          const auto text = from_u8(
              ...
              "<p style=\"text-align:left\"><a style=\"color:#009789\" href=\"https://github.com/ANYRAID/ANYRAID-ORCA\">github.com/ANYRAID/ANYRAID-ORCA</a></p>"
              "</body>"
              "</html>")
            ).str());
          m_html->SetPage(text);
